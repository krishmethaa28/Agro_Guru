    ...
    return Scaffold(
      ...
      children: <Widget>[
            ...
            SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Carousel(
                      images: [
                        AssetImage('assets/potLate.JPG'),
                        AssetImage('assets/potLate2.JPG'),
                        AssetImage('assets/potLate3.JPG'),
                      ],
                      dotSize: 4.0,
                      dotSpacing: 15.0,
                      autoplay: false,
        ...
        Padding(
          ...
          child: Text(
            'Dark spotted marks in leaves with drying',
        ...
        Padding(
          ...
          child: Text(
            'Natural remedy: Take 250g of sera leaves and roots and grind it well. Mix it with 1 litre of water and let it sit for 4 to 5 hours. Extract the solution and spray it to the affected plants. \n'
            'Artificial remedy: Terranil 6L',
            textAlign: TextAlign.justify,
            style: TextStyle(fontSize: 17, fontFamily: 'Raleway'),
          ),
        ),
