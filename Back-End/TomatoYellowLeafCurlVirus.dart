...
class TomatoYellowLeafCurlVirus extends StatefulWidget {
  TomatoYellowLeafCurlVirus({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _TomatoYellowLeafCurlVirusState createState() => _TomatoYellowLeafCurlVirusState();
}
    ...
    return Scaffold(
        body: ListView(
                ...
                SizedBox(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Carousel(
                          images: [
                            AssetImage('assets/tomYel.JPG'),
                            AssetImage('assets/tomYel2.JPG'),
                            AssetImage('assets/tomYel3.JPG'),
                          ],
                          dotSize: 4.0,
                          dotSpacing: 15.0,
                          autoplay: false,
          ...
          padding: EdgeInsets.only(top: 5, bottom: 10, left: 14, right: 14),
              child: Text('Curly ends in the leaves.',
                style: TextStyle(
                  fontSize: 17,
          ...
          padding: EdgeInsets.only(top: 5.0, bottom: 20, left: 14, right: 14),
              child: Text('Natural remedy: Suspicious crops can be prevented by uprooting and trying Use to dry weather fan watering and yellow driving trap. \n'
                      'Artificial remedy: TAURUS 500SP 10g/20l',
