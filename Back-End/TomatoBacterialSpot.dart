...
class TomatoBacterialSpot extends StatefulWidget {
  TomatoBacterialSpot({Key key, this.title}) : super(key: key);
  final String title;
    ...
    return Scaffold(
      ...
      children: <Widget>[
            ...
            SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Carousel(
                      images: [
                        AssetImage('assets/tomBacSpot.JPG'),
                        AssetImage('assets/tomBacSpot2.JPG'),
                        AssetImage('assets/tomBacSpot3.JPG'),
                      ],
                      dotSize: 4.0,
                      dotSpacing: 15.0,
                      autoplay: false,
        ...
        Padding(
          ...
          child: Text(
            'Rotten brown ends in the leaves.',
        ...
        Padding(
          ...
          child: Text(
            'Natural remedy: Pluck all the affected leaves and burn them together. \n'
