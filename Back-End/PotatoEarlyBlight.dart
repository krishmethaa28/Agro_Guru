    ...
    return Scaffold(
      ...
      children: <Widget>[
            ...
            SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Carousel(
                      images: [
                        AssetImage('assets/potEarlyBlight.JPG'),
                        AssetImage('assets/potEarlyBlight2.JPG'),
                        AssetImage('assets/potEarlyBlight3.JPG'),
                      ],
                      dotSize: 4.0,
                      dotSpacing: 15.0,
                      autoplay: false,
        ...
        Padding(
          ...
          child: Text(
            'Dried leaves with black colored spots',
        ...
        Padding(
          ...
          child: Text(
            'Natural remedy: Take one handful of dried onion skins and boil it with 4 liters of water until it turns to gold color. Filter the solution and spray it to the plants. \n'
            'Artificial remedy: Agronil 500',
            textAlign: TextAlign.justify,
            style: TextStyle(fontSize: 17, fontFamily: 'Raleway'),
          ),
        ),
