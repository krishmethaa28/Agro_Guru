    ...
    return Scaffold(
      ...
      children: <Widget>[
            ...
            SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Carousel(
                      images: [
                        AssetImage('assets/tomEarly.JPG'),
                        AssetImage('assets/tomEarly2.JPG'),
                        AssetImage('assets/tomEarly3.JPG'),
                      ],
                      dotSize: 4.0,
                      dotSpacing: 15.0,
                      autoplay: false,
        ...
        Padding(
          ...
          child: Text(
            'Rotten leaves with brwonish yellow withered parts.',
        ...
        Padding(
          ...
          child: Text(
            'Natural remedy: Grind 100g of turmeric yam well and add 1 liter of cow urine and 2 liters of water. \n\n'
            'Artificial remedy: Revus Top',
            textAlign: TextAlign.justify,
            style: TextStyle(fontSize: 17, fontFamily: 'Raleway'),
          ),
        ),
