...
class TomatoSeptoriaLeafSpot extends StatefulWidget {
  TomatoSeptoriaLeafSpot({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _TomatoSeptoriaLeafSpotState createState() => _TomatoSeptoriaLeafSpotState();
}
    ...
    return Scaffold(
      ...
      children: <Widget>[
            ...
            SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Carousel(
                      images: [
                        AssetImage('assets/tomSep.JPG'),
                        AssetImage('assets/tomSep2.JPG'),
                        AssetImage('assets/tomSep3.JPG'),
                      ],
                      dotSize: 4.0,
                      dotSpacing: 15.0,
                      autoplay: false,
        ...
        Padding(
          ...
          child: Text(
            'Natural remedy: Smash the leaves of turmeric well and extract the solution and spray to the plants. \n'
            'Artificial remedy: Dithane, Manzate, Penncozeb',
            textAlign: TextAlign.justify,
            style: TextStyle(fontSize: 17, fontFamily: 'Raleway'),
          ),
        ),
